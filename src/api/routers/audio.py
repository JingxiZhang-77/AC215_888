...
async def transcribe_audio(
    ...
    try:
        ...
        try:
            ...
            logger.info(
                f"Transcription complete. Language: {result['original_language']}, Translated: {result['was_translated']}"
            )
...
async def list_supported_languages():
    ...
    return {
        "languages": [
            {"code": code, "name": info["name"], "needs_translation": info["needs_translation"]}
